...
export declare const createServiceSchema: z.ZodObject<{
     ...
     */
    protocol: z.ZodOptional<z.ZodEnum<["http", "tcp"]>>;
}, "strip", z.ZodTypeAny, {
    name: string;
    port: number;
    region: string;
...
export declare const computeLogLineSchema: z.ZodObject<{
...
export declare const computeLogsResponseSchema: z.ZodObject<{
